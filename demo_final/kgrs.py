...
class KGRS:
    def __init__(self, train_pos: np.array, train_neg: np.array, kg_lines: List[str], config=None):
        """
        ...
        if config is None:
            config = {"batch_size": 256, "eval_batch_size": 124, "neg_rate": 0.1, "emb_dim": 256, "l1": False,
                      "margin": 30,
        ...
        #           'margin': 261, 'learning_rate': 0.00996875, 'weight_decay': 0.01, 'epoch_num': 60}
        print(config)
